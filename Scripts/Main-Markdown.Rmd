---
title: "WRONG Rethinking Traditional Values: Analyzing How Messages of Climate Change Affect Family Planning Among Millennials and Generation Z"
...
css_ghana %>% 
  ...
  summarise(mean_message = mean(q_10_cc_message_effec_providing_info, na.rm = TRUE),
            avrg_desire = mean(q_17_cc_infuence_child_desire, fill = age_gen_recoded)) %>% 
...
research_questions <- css_ghana %>% 
  ...
  rename(
    ...
    "Think about messages you’ve seen in the media about climate change. How effective were they in terms of providing information?" = q_10_cc_message_effec_providing_info,
