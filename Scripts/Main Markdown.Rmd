...
css_ghana %>% 
  ...
  guides(fill=guide_legend(title= "Age Generation"))
 ...
 group_by(age_gen_recoded) %>% 
  ...
  theme_minimal() +
   labs(x = "Age Generation",
         ...
         title = "Climate Change Influence on Desire For Children",
         subtitle = "(Data obtained from a survey in Ghana, West Africa)") +
  ...
  geom_smooth() +
   guides(fill=guide_legend(title= "Age Generation")) +
    labs(x = "Climate Change Media Effectiveness",
         y = "Average Influence of Climate Change on Desire For Children",
         title = "Climate Change Messaging on Desire For Children",
         subtitle = "(Data obtained from a survey in Ghana, West Africa)") 
